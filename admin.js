...
export async function renderAdmin() {
  ...
  document.getElementById('settings').innerHTML = `
    ...
    <h3>Cvičení</h3>
    <p class="note">Všechna cvičení se zapisují jako celé číslo. U Planku doporučuji jednotku <b>s</b> nebo <b>sekund</b>.</p>
      ...
      <div class="card" style="background:#f9fafb">
        <div class="row">
          ...
          <div>
            ...
            <input id="etarget_${e.key}" value="${esc(e.target || '')}" placeholder="např. 30">
          </div>
          <div>
            <label>Jednotka</label>
            <input id="eunit_${e.key}" value="${esc(e.unit || '')}" placeholder="ks / s / sekund">
          </div>
