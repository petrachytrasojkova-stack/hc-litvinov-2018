...
export const state={currentUser:null,currentAdmin:false,players:[],plans:[],exercises:[],entries:[],admin:{password:'hclitvinov',phone:''}};

export function renderApp(){
  document.getElementById('app').innerHTML=`
    <div class="card"><h1>HC Litvínov - ročník 2018</h1><div class="muted"><span id="activePlanTitle">Léto 2026</span> · online tréninkový deník</div></div>
